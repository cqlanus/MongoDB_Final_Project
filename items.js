...
function ItemDAO(database) {
    ...
    this.getCategories = function(callback) {
        ...
        */
        ...
        // var sum = database.collection('item').find().count();
    ...
    this.getItems = function(category, page, itemsPerPage, callback) {
         ...
         */
         ...
         var pageItems = this.db.collection('item')
                        .find(findQuery)
                        .sort( { "_id": 1})
                        .limit(itemsPerPage)
                        .skip(skipNum)
    ...
    this.getNumItems = function(category, callback) {
        ...
        var numItems = this.db.collection('item').find(findQuery)
    ...
    this.searchItems = function(query, page, itemsPerPage, callback) {
         ...
         */
         var skipNum = (page)*itemsPerPage;
        var items = this.db.collection('item').find({
            $text: { $search: query}            
        },{
    ...
    this.getItem = function(itemId, callback) {
        ...
        var item = this.db.collection('item').find({
            _id: itemId
        }).toArray(function(err,docs){
            assert.equal(null, err);
            // console.log(docs[0]);
